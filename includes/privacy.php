...
function himoose_add_privacy_policy_content() {
	...
	$content = sprintf(
		...
		__( 'Listen to This Article as a Podcast (Hi, Moose)', 'listen-to-this-article' ),
		__( 'This site uses the "Listen to This Article as a Podcast" plugin to provide audio versions of articles. This service is powered by Hi, Moose.', 'listen-to-this-article' ),
		__( 'When you load a page with a podcast player, or when the site administrator fetches podcast data:', 'listen-to-this-article' ),
	...
	wp_add_privacy_policy_content(
		__( 'Listen to This Article as a Podcast', 'listen-to-this-article' ),
