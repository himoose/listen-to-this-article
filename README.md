...
Podcast-Style Text to Speech is an open-source WordPress plugin by Hi, Moose that turns
WordPress posts into natural-sounding, podcast-style text-to-speech audio with a visible transcript.

## What this plugin does
- Adds a podcast-style text-to-speech audio player to WordPress posts
- Embeds natural-sounding audio generated by Hi, Moose
...
- Includes visible, crawlable transcripts and PodcastEpisode schema
...
Audio playback, visible transcripts, and structured data are delivered as a single,
self-contained embed that requires no manual audio file management.

## How to use
1. Install and activate the plugin, then use the onboarding flow to connect with Quick Connect or paste your existing API key manually.
